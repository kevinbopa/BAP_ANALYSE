...
--
-- Les bourses d'echange (Betfair Exchange, Matchbook...) affichent pour les
-- outsiders golf sans liquidite des prix placeholder/last-traded incoherents
-- (ex: un journeyman cote 2.0 pour gagner un major). Ces prix ne sont ni
-- reels ni jouables. On les exclut de la "meilleure cote" affichee sur le
-- board golf pour que la cote montree et l'edge affiche soient actionnables.
-- (Le consensus/deals les excluent deja cote moteur : run_golf_predictions.)
--
-- Betfair *Sportsbook* (_SB_) reste inclus : c'est un vrai bookmaker.
